...
import sty from "./PlasmicButton.module.css"; // plasmic-import: qFnSZGu4O47/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: E36QpBAKQmv/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: z3BXVpHfGGG/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__oCiKc)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__tBms5)}
                role={"img"}
              />
            ),
